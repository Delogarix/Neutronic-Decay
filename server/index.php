    ...
    <body class="color-main">
        ...
        <main class="container">
            ...
            <div class="text-center">
                <h1>Neutronic-Decay</h1>
            </div>
            <br>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem aspernatur harum, aliquam rerum dolores odio inventore quo maxime fugiat natus odit! Facere totam ex perspiciatis eligendi provident fugit suscipit non!</p>
        </main>
